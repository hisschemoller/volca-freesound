        ...
        <Col>
          <Section title="About the application">
            <p className={s.p}>
              ...
              <a href="http://https.freesound.org" target="_blank">
                Freesound
              </a>{' '}
          ...
          <Section title="About myself"><p className={s.p}>bla</p></Section>
        </Col>
        <Col>
          <Section title="Acknowledgments">
            ...
            <p className={s.p}>To convert the audio files to the type of signal the Volca Sample uses, I used the syro.js library that Panagiotis Tigas translated to Javascript from the original SYRO SDK by Korg.</p>
          </Section>
        </Col>
      </Grid>
    );
